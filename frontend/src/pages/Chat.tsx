  ...
  return (
    <div className="flex h-screen overflow-hidden bg-white text-slate-900 antialiased font-sans">
      ...
      >
        ...
        {/* Primary Action Button: + New Chat (ChatGPT Pill Style) */}
        <div className="p-3">
          <button
                ...
                {conversations.map((conv) => (
                  ...
                  >
                    ...
                    <Trash2
                      ...
                      className="h-3.5 w-3.5 shrink-0 opacity-0 transition-opacity hover:text-rose-500 group-hover:opacity-100"
                    />
                  </button>
                ))}
              </div>
